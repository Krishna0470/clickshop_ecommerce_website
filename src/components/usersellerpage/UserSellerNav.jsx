  ...
  <nav className="navbar">
    <div className="navbar-container">
      ...
      <ul className="menu-items">
        ...
        <li>
          <a href="/MensCategory">Men</a>
        </li>
        <li>
          <a href="/WomenCategory">Women</a>
        </li>
        <li>
          <a href="/KidsCategory">Kids</a>
        </li>
        <li>
